...
#ifndef PREBIDMOBILEGAMEVENTHANDLERS_SWIFT_H
#define PREBIDMOBILEGAMEVENTHANDLERS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PrebidMobileGAMEventHandlers",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC28PrebidMobileGAMEventHandlers21GAMBannerEventHandler")
@interface GAMBannerEventHandler : NSObject <GADAdSizeDelegate, GADAppEventDelegate, GADBannerViewDelegate, BannerEventHandler>
...
- (void)interstitialAd:(GADInterstitialAd * _Nonnull)interstitialAd didReceiveAppEvent:(NSString * _Nonnull)name withInfo:(NSString * _Nullable)info;
- (void)adView:(GADBannerView * _Nonnull)bannerView willChangeAdSizeTo:(GADAdSize)size;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, GAMEventHandlerError, open) {
  GAMEventHandlerErrorGamClassesNotFound = 0,
  GAMEventHandlerErrorNoLocalCacheID = 1,
  GAMEventHandlerErrorInvalidLocalCacheID = 2,
  GAMEventHandlerErrorInvalidNativeAd = 3,
  GAMEventHandlerErrorNonPrebidAd = 4,
  GAMEventHandlerErrorNoAd = 5,
};
static NSString * _Nonnull const GAMEventHandlerErrorDomain = @"PrebidMobileGAMEventHandlers.GAMEventHandlerError";

@protocol InterstitialEventLoadingDelegate;
@protocol InterstitialEventInteractionDelegate;
@class UIViewController;

SWIFT_CLASS("_TtC28PrebidMobileGAMEventHandlers27GAMInterstitialEventHandler")
@interface GAMInterstitialEventHandler : NSObject <GADAppEventDelegate, GADFullScreenContentDelegate, InterstitialEventHandlerProtocol>
...
SWIFT_CLASS("_TtC28PrebidMobileGAMEventHandlers25GAMRewardedAdEventHandler")
@interface GAMRewardedAdEventHandler : NSObject <GADAdMetadataDelegate, GADFullScreenContentDelegate, RewardedEventHandlerProtocol>
@property (nonatomic, readonly, copy) NSString * _Nonnull adUnitID;
- (nonnull instancetype)initWithAdUnitID:(NSString * _Nonnull)adUnitID OBJC_DESIGNATED_INITIALIZER;
- (void)adMetadataDidChange:(id <GADAdMetadataProvider> _Nonnull)ad;
...
SWIFT_CLASS("_TtC28PrebidMobileGAMEventHandlers8GAMUtils")
@interface GAMUtils : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) GAMUtils * _Nonnull shared;)
+ (GAMUtils * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
@interface GAMUtils (SWIFT_EXTENSION(PrebidMobileGAMEventHandlers))
