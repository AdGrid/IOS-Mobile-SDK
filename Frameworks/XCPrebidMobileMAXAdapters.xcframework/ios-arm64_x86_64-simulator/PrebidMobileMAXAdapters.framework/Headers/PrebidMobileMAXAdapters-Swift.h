...
#ifndef PREBIDMOBILEMAXADAPTERS_SWIFT_H
#define PREBIDMOBILEMAXADAPTERS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PrebidMobileMAXAdapters",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters12MAXConstants")
@interface MAXConstants : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull PrebidMAXAdapterVersion;)
+ (NSString * _Nonnull)PrebidMAXAdapterVersion SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters23MAXMediationBannerUtils")
@interface MAXMediationBannerUtils : NSObject <PrebidMediationDelegate>
@property (nonatomic, strong) MAAdView * _Nonnull adView;
- (nonnull instancetype)initWithAdView:(MAAdView * _Nonnull)adView OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters29MAXMediationInterstitialUtils")
@interface MAXMediationInterstitialUtils : NSObject <PrebidMediationDelegate>
@property (nonatomic, strong) MAInterstitialAd * _Nonnull interstitialAd;
- (nonnull instancetype)initWithInterstitialAd:(MAInterstitialAd * _Nonnull)interstitialAd OBJC_DESIGNATED_INITIALIZER;
- (BOOL)setUpAdObjectWith:(NSDictionary<NSString *, id> * _Nonnull)values SWIFT_WARN_UNUSED_RESULT;
- (void)cleanUpAdObject;
- (UIView * _Nullable)getAdView SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters23MAXMediationNativeUtils")
@interface MAXMediationNativeUtils : NSObject <PrebidMediationDelegate>
@property (nonatomic, strong) MANativeAdLoader * _Nonnull nativeAdLoader;
- (nonnull instancetype)initWithNativeAdLoader:(MANativeAdLoader * _Nonnull)nativeAdLoader OBJC_DESIGNATED_INITIALIZER;
- (BOOL)setUpAdObjectWith:(NSDictionary<NSString *, id> * _Nonnull)values SWIFT_WARN_UNUSED_RESULT;
- (void)cleanUpAdObject;
- (UIView * _Nullable)getAdView SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters25MAXMediationRewardedUtils")
@interface MAXMediationRewardedUtils : NSObject <PrebidMediationDelegate>
@property (nonatomic, strong) MARewardedAd * _Nonnull rewardedAd;
- (nonnull instancetype)initWithRewardedAd:(MARewardedAd * _Nonnull)rewardedAd OBJC_DESIGNATED_INITIALIZER;
- (BOOL)setUpAdObjectWith:(NSDictionary<NSString *, id> * _Nonnull)values SWIFT_WARN_UNUSED_RESULT;
- (void)cleanUpAdObject;
- (UIView * _Nullable)getAdView SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters8MAXUtils")
...
SWIFT_CLASS("_TtC23PrebidMobileMAXAdapters23PrebidMAUnifiedNativeAd")
@interface PrebidMAUnifiedNativeAd : MANativeAd
@property (nonatomic, strong) NativeAd * _Nonnull nativeAd;
- (nonnull instancetype)initWithNativeAd:(NativeAd * _Nonnull)nativeAd OBJC_DESIGNATED_INITIALIZER;
- (BOOL)prepareForInteractionClickableViews:(NSArray<UIView *> * _Nonnull)clickableViews withContainer:(UIView * _Nonnull)container SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFormat:(MAAdFormat * _Nonnull)format builderBlock:(SWIFT_NOESCAPE void (^ _Nonnull)(MANativeAdBuilder * _Nonnull))builderBlock SWIFT_UNAVAILABLE;
@end

@protocol MAAdapterInitializationParameters;
@class ALSdk;

SWIFT_CLASS_NAMED("PrebidMAXMediationAdapter")
@interface PrebidMAXMediationAdapter : ALMediationAdapter
...
@interface PrebidMAXMediationAdapter (SWIFT_EXTENSION(PrebidMobileMAXAdapters)) <MANativeAdAdapter, NativeAdEventDelegate>
...
@interface PrebidMAXMediationAdapter (SWIFT_EXTENSION(PrebidMobileMAXAdapters)) <MAAdViewAdapter, DisplayViewInteractionDelegate, DisplayViewLoadingDelegate>
...
@interface PrebidMAXMediationAdapter (SWIFT_EXTENSION(PrebidMobileMAXAdapters)) <MAInterstitialAdapter, MARewardedAdapter, InterstitialControllerInteractionDelegate, InterstitialControllerLoadingDelegate>
